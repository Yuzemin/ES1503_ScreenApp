...
namespace ShouldPadMachine.ShouldPadMachineAssist
{
    namespace Enum
    {
        ...
        public enum WarnType : byte
        {
            ...
            Y_OCurWarn,            
            SysTimeOutWarn,
            TakeClothUpperSensorWarn,
            TakeClothMidSensorWarn,
            TakeClothDownSensorWarn,
            TakeClothLeftSensorWarn,
            TakeClothRightSensorWarn,
            XBackToZeroSensorWarn,
            YBackToZeroSensorWarn,
            ServoBackToZeroSensorWarn,
            SysRePowerWarn,
            Null,
        }
